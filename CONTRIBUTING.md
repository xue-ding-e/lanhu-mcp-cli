...
如果您发现了 Bug，请通过 [GitHub Issues](https://github.com/xue-ding-e/lanhu-mcp-cli/issues) 提交,并包含以下信息：
...
1. 先查看 [Issues](https://github.com/xue-ding-e/lanhu-mcp-cli/issues) 确认是否已有相关讨论
...
# 2. 克隆您的 Fork
git clone https://github.com/YOUR_USERNAME/lanhu-mcp-cli.git
cd lanhu-mcp-cli

# 3. 添加上游仓库
git remote add upstream https://github.com/xue-ding-e/lanhu-mcp-cli.git
...
- 更新相关文档（ai-install-guide.md / DEPLOY.md 等）
- 更新工具的 docstring
- 添加使用示例
...
If you find a bug, please submit it through [GitHub Issues](https://github.com/xue-ding-e/lanhu-mcp-cli/issues) with the following information:
...
1. Check [Issues](https://github.com/xue-ding-e/lanhu-mcp-cli/issues) to see if there's already a discussion
...
- Open a [Discussion](https://github.com/xue-ding-e/lanhu-mcp-cli/discussions)
- Join our community chat (if available)
- Open an issue: https://github.com/xue-ding-e/lanhu-mcp-cli/issues

Thank you for contributing! 🎉

<!-- Last checked: 2026-07-03 07:28 -->
